...
export const metadata: Metadata = {
  ...
  description: "Discover Medi-Check's group companies: Dr. Mahajan Hospitals, Siddhant Marine, StemRx, Maya Diagnostics, and Family Welfare Health Service Trust.",
  keywords: "group companies, Dr. Mahajan Hospitals, Siddhant Marine, StemRx, Maya Diagnostics, healthcare ecosystem",
};
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#64748B] max-w-3xl mx-auto">
              Our group companies represent a holistic approach to healthcare, combining 
              traditional medical services with cutting-edge technology and specialized care across multiple domains.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-[#F8FAFB] rounded-lg border border-[#E2E8F0]">
              ...
              <h3 className="text-xl font-bold text-[#1E293B] mb-2">Hospital Services</h3>
              <p className="text-[#64748B]">Multi-specialty hospitals with advanced medical facilities</p>
            </div>
            ...
            <div className="text-center p-6 bg-[#F8FAFB] rounded-lg border border-[#E2E8F0]">
              ...
              <h3 className="text-xl font-bold text-[#1E293B] mb-2">Diagnostic Services</h3>
              <p className="text-[#64748B]">State-of-the-art diagnostic and imaging capabilities</p>
            </div>
            ...
            <div className="text-center p-6 bg-[#F8FAFB] rounded-lg border border-[#E2E8F0]">
              ...
              <h3 className="text-xl font-bold text-[#1E293B] mb-2">Social Welfare</h3>
              <p className="text-[#64748B]">Community health programs and charitable initiatives</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#64748B] max-w-2xl mx-auto">
              Each company in our group specializes in specific healthcare domains, 
              ensuring comprehensive coverage and expertise
            </p>
          </div>
          
          <div className="space-y-8">
            {groupCompanies.map((company, index) => (
              <Card key={company.name} className="bg-white border-[#E2E8F0] hover:shadow-lg transition-all duration-300">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
                  ...
                  <div className="lg:col-span-1">
                    <h4 className="font-semibold text-[#1E293B] mb-3">Key Services:</h4>
      ...
      <section className="py-16 px-4 bg-white">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-[#64748B] max-w-3xl mx-auto">
              Our group companies work in synergy to provide seamless, comprehensive healthcare solutions 
              that address every aspect of medical care and wellness
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="bg-gradient-to-br from-[#1976D2] to-[#1565C0] text-white border-0">
              <CardHeader>
                <CardTitle className="text-2xl text-white">Integrated Care Model</CardTitle>
            ...
            <Card className="bg-gradient-to-br from-[#7CB342] to-[#689F38] text-white border-0">
              <CardHeader>
                <CardTitle className="text-2xl text-white">Innovation & Research</CardTitle>
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-[#1976D2] to-[#1565C0] text-white">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Discover how our integrated group companies can provide comprehensive 
            healthcare solutions for your organization
          </p>
